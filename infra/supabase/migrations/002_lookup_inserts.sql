...
INSERT INTO personas (name, description, self_describing, decompose_threshold) VALUES
('Procrastinator', 'Pending', $$I often feel a heavy 'friction' when trying to start tasks, even when I know they are important and I really want to get them done.$$, 7),
('Overwhelmed Planner', 'Pending', $$I have a million great ideas and lists, but I get stuck in 'choice paralysis' trying to figure out which one is the right one to do first.$$, 6),
('Hyper-focused', 'Pending', $$Once I 'lock in' to a task, the rest of the world disappears, making it very difficult for me to stop, eat, or switch gears to what's next.$$, 8);
...
('Planner', 'Pending', $$When I sit down to plan my life, I genuinely believe I can become more organized, confident, and proud of myself.$$),
