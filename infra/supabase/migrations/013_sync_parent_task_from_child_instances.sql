DROP FUNCTION IF EXISTS public.sync_parent_task_from_latest_child_instances(uuid);
...
GRANT EXECUTE ON FUNCTION public.sync_parent_task_from_latest_child_instances(uuid, uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.sync_parent_task_from_latest_child_instances(uuid, uuid) TO service_role;
